...
<body style="background-color: #FFE3BB;">
    <div class="container">
                        ...
                        <div class="card border border-warning" style="width: 20rem;">
                            <div class="card-body">
                                ...
                                <a href="halamanUpdate.php? ID=<?php echo $row['Id'] ?>" class="btn btn-outline-warning mx-3"><i class="fa-solid fa-pen-to-square"></i>
                                    <a href="delete.php? ID= <?php echo $row['Id'] ?>" class="btn btn-outline-danger icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);"><i class="fa-solid fa-trash-can"></i></a>
    ...
    <footer>
        <p>Copyright &copy; 2023 | Rayvan Ahnaf</p>
    </footer>
